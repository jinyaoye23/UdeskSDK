...
Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/jinyaoye23/UdeskSDK'
  s.author       = {'jinyao ' => 'jinyaoye23@126.com'}
  s.source       =  {:git => 'https://github.com/jinyaoye23/UdeskSDK.git', :tag => s.version.to_s }
  s.platform     = :ios, '6.0'
  s.requires_arc = true
