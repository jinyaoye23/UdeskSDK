...
- (void)initilzer {
    ...
    if (self.sdkConfig.customBackBarButton) {
        self.navigationController.navigationBar.backIndicatorTransitionMaskImage = [[UIImage imageNamed:@"arrow_back.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        self.navigationController.navigationBar.backIndicatorImage = [[UIImage imageNamed:@"arrow_back.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        self.navigationItem.backBarButtonItem = self.sdkConfig.customBackBarButton;
        //        self.navigationItem.leftBarButtonItem = self.sdkConfig.customBackBarButton;
    }
